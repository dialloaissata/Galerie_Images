...
$allImages = $galerie->getImageBetween($start, $count, "maq");
?>
...
?>
<script src="./assets/js/lang.js?parent=maquillages.php" defer></script>
<script src="/assets/js/ajax.js?type=maq" defer></script>
</head>
