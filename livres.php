...
$allImages = $galerie->getImageBetween($start, $count, "liv");
?>
...
?>
<script src="./assets/js/lang.js?parent=livres.php" defer></script>
<script src="/assets/js/ajax.js?type=liv" defer></script>
</head>
